            ...
            <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
              ...
              <form onSubmit={handleCreate} className="p-6 grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <input name="phone" value={form.phone} onChange={handleChange} placeholder="+2349123456789" type="tel" className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent" />
                </div>
                <div>
