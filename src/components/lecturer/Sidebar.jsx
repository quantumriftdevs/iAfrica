...
const LogoutButton = () => {
  ...
  return (
    <button onClick={handle} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left text-gray-300 hover:bg-blue-700/50 hover:text-white transition-all duration-200 group font-medium text-sm">
