      ...
      <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-gray-50">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white transition-all duration-200"
          />
        </div>
      </div>
        ...
        <table className="min-w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            {paginatedData.map((row, idx) => (
              <tr 
                key={row._id || idx} 
                className="hover:bg-purple-50/40 transition-colors duration-200 cursor-pointer"
              >
